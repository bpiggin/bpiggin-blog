...
1. **Conversion** - Higher conversion rates for organic visitors (14.6% according to Hubspot[^3])
2. **Trust** - Increased confidence in your brand
...
So how does NextJS help with this? Well, in order to rank your page, Google first has to crawl your site using a bot in order to discover all of its pages. After that it will analyse their content in a process called indexing. Over 200 variables calculated as part of this indexing process are then used to determine your ranking in search results.
...
1. Client-side rendered Javascript often returns success status codes when it should return error codes making it hard for the Google bot to figure out which pages exist
2. If the page takes a long time to render the HTML document then the Google bot may timeout and fail to index the page
...
React is an excellent choice when it comes to staying power. The framework was built by Facebook and is still supported by a permanent team there. Over 10 million website use React[^12] including businesses like Uber, Netflix, Instagram and the BBC. The framework consistently leads in areas such as developer usage[^13], hiring trends[^14], and Google trends[^15].
...
**Built on the bedrock of React, companies using NextJS can be sure that the technology underlying it is popular and widely supported, bringing benefits in hiring, training and insuring against short term migrations.**

# NextJS has a wealth of industry support

While React may be fairly future-proof, it's also important to measure the level of support for NextJS itself and the major players involved in its development. As mentioned in the introduction, NextJS is built by Vercel, a $2.5 billion company at last valuation. Vercel provide a permanent team working on NextJS, in addition to this NextJS is open source and receives contributions from the developer community. Google have also provided support from their own development team, improving the performance of the framework.
...
For all the reasons listed above, NextJS has replaced React in our standard stack at Theodo. We've seen the benefits it can bring to businesses in the E-Commerce space and other sectors with excellent performance and SEO benchmarks achieved on our projects. For your next project, strongly consider NextJS as your frontend solution.
...
>
  <div style={{ marginRight: '2rem' }}>
    <img src="/static/images/theodo.png" alt="drawing" width="130" />
  </div>
  <div>
    <h2 style={{ marginTop: '1rem', marginBottom: 0, color: 'white' }}>
      We help you build the tech capability to stand out in your market
    </h2>
    <div style={{ marginTop: '-1rem', marginBottom: '1rem' }}>
      <a
        href="https://www.theodo.co.uk/contact?hsLang=en-gb"
        target="_blank"
        className="text-primary-500 hover:text-primary-600 dark:hover:text-primary-400 no-underline"
...
[^10]: https://www2.deloitte.com/content/dam/Deloitte/ie/Documents/Consulting/Milliseconds_Make_Millions_report.pdf
