...
<div className="flex w-full">
  ...
  <div className="flex-1 w-full">
    <h4>Cons</h4>
    <ul>
      <li>❌ Users have to install VPN client</li>
    </ul>
  </div>
</div>
...
After the above analysis we concluded
...
At Theodo UK we use [Terraform](https://www.terraform.io/) to provision infrastructure in AWS which brings all the benefits of infrastructure as code.
